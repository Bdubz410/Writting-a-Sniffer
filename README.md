With this project I built a UDP host discovery tool. This sniffer simply sniffs just one network packet on the wire; must run in command prompt as admin and will not have tracebacks.
